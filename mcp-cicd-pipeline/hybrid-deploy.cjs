...
class HybridMCPDeployer {
    constructor(options = {}) {
        ...
        // Detect if running in GitHub Actions and use appropriate SSH key path
        const defaultSshKeyPath = process.env.GITHUB_ACTIONS 
            ? process.env.HOME + '/.ssh/id_rsa'
            : 'auth_organized/keys_configs/mcp_docker_key';
        this.sshKeyPath = options.sshKeyPath || defaultSshKeyPath;
        this.requestId = 1;
